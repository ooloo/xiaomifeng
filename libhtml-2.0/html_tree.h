...
class html_tree {
  ...
  private:
    ...
    int is_child_tag(html_tree_t * html_tree, html_node_t * parent,
                     html_node_t * child);
    ...
    int html_tree_parse_sub_tree(html_tree_t * html_tree,
    ...
    html_node_t *search_tag_node(html_node_t * start_node,
                                 const char *tagname);

    /* internal function for tree visit */
    int html_node_visit(html_node_t * html_node,
                        int (*start_visit) (html_tag_t * html_tag,
                                            void *result, int min_font),
  ...
  public:
     ...
     **/
    html_tree_t *get_tree() {
        return tree;
    }
                                           /*parse the tree *//* visit the tree *//**
    ...
    *@retval 1:  normal
    **/ int
     html_tree_visit(int (*pre_visit)
                     (html_tag_t * html_tag, void *result,
                      int min_font),
                     int (*post_visit) (html_tag_t * html_tag,
                                        void *result), void *result);
