...
html_tag_info_t html_tag_info_array[] = {
	{ "a", TAG_A, 1, 0, 1, 0, 0, 0, { // 62 parents
						...
						"abbr"    , "acronym" , "address" , "applet"  , "b"       , 
						"bdo"     , "big"     , "blink"   , "blockquote", "body"    , 
						"caption" , "center"  , "cite"    , "code"    , "dd"      , 
						"del"     , "dfn"     , "div"     , "dl"      , "dt"      , 
						"em"      , "fieldset", "font"    , "form"    , "h1"      , 
						"h2"      , "h3"      , "h4"      , "h5"      , "h6"      , 
						"html"    , "i"       , "iframe"  , "ins"     , "kbd"     , 
						"label"   , "layer"   , "legend"  , "li"      , "marquee" , 
	...
	{ "frame", TAG_FRAME, 0, 0, 1, 0, 1, 1, { // 4 parents
						...
						"body"    , "frameset", "html"    , "td"      , 
						NULL}
	},
	{ "noframes", TAG_NOFRAME, 0, 0, 1, 0, 1, 1, { // 22 parents

						"blockquote", "body"    , "button"  , "center"  , "dd"      , 
						"div"     , "dl"      , "fieldset", "form"    , "frameset", 
						"html"    , "iframe"  , "layer"   , "li"      , "marquee" , 
						"multicol", "noframes", "nolayer" , "noscript", "object"  , 
						"td"      , "th"      , 
						NULL}
	},
	{ "iframe", TAG_IFRAME, 0, 0, 1, 0, 1, 1, { // 64 parents

						"a"       , "acronym" , "address" , "applet"  , "b"       , 
						"bdo"     , "big"     , "blink"   , "blockquote", "body"    , 
						...
						"h5"      , "h6"      , "html"    , "i"       , "iframe"  , 
						"ins"     , "kbd"     , "label"   , "layer"   , "legend"  , 
						"li"      , "marquee" , "multicol", "nobr"    , "noframes", 
						"nolayer" , "noscript", "object"  , "p"       , "pre"     , 
						"q"       , "s"       , "samp"    , "small"   , "span"    , 
	...
	{ "div", TAG_DIV, 1, 0, 1, 0, 1, 1, { // 25 parents
						...
						"blockquote", "body"    , "button"  , "center"  , "dd"      , 
						"del"     , "div"     , "dl"      , "dt"      , "fieldset", 
						"form"    , "html"    , "iframe"  , "ins"     , "layer"   , 
						"li"      , "map"     , "marquee" , "multicol", "noframes", 
						"nolayer" , "noscript", "object"  , "td"      , "th"      , 
						NULL}
	},
	...
	{ "table", TAG_TABLE, 0, 0, 1, 1, 1, 1, { // 30 parents
						...
						"applet"  , "blockquote", "body"    , "button"  , "center"  , 
						"dd"      , "del"     , "div"     , "dl"      , "dt"      , 
						"embed"   ,"fieldset" ,	"form"    , "html"    , "iframe"  , 
						"ins"     , "layer"   , "li"      , "map"     , "marquee" , 
						"multicol", "noembed" , "noframes", "nolayer" , "noscript",
						"object"  , "p"       , "pre"     , "td"      , "th"      , 
						NULL}
	},
	...
	{ "textarea", TAG_TEXTAREA, 1, 0, 1, 0, 0, 0, { // 57 parents
						...
						"a"       , "abbr"    , "acronym" , "address" , "applet"  , 
						"b"       , "bdo"     , "big"     , "blockquote", "body"    , 
						"caption" , "center"  , "cite"    , "code"    , "dd"      , 
						"del"     , "dfn"     , "div"     , "dl"      , "dt"      , 
						"em"      , "fieldset", "font"    , "form"    , "h1"      , 
						"h2"      , "h3"      , "h4"      , "h5"      , "h6"      , 
						"html"    , "i"       , "iframe"  , "ins"     , "kbd"     , 
						"label"   , "legend"  , "li"      , "noframes", "noscript", 
						"object"  , "p"       , "pre"     , "q"       , "s"       , 
						"samp"    , "small"   , "span"    , "strike"  , "strong"  , 
						"sub"     , "sup"     , "td"      , "th"      , "tt"      , 
						"u"       , "var"     , 
	...
	{ "object", TAG_OBJECT, 1, 0, 1, 0, 0, 0, { // 65 parents
						...
						"form"    , "h1"      , "h2"      , "h3"      , "h4"      , 
						"h5"      , "h6"      , "head"    , "html"    , "i"       , 
						"iframe"  , "ins"     , "kbd"     , "label"   , "layer"   , 
						"legend"  , "li"      , "marquee" , "multicol", "nobr"    , 
						"noframes", "nolayer" , "noscript", "object"  , "p"       , 
						"pre"     , "q"       , "s"       , "samp"    , "small"   , 
	...
	{ "ol", TAG_OL, 0, 0, 1, 0, 1, 1, { // 24 parents
						...
						"blockquote", "body"    , "button"  , "center"  , "dd"      , 
						"del"     , "div"     , "dl"      , "fieldset", "form"    , 
						"html"    , "iframe"  , "ins"     , "layer"   , "li"      , 
						"map"     , "marquee" , "multicol", "noframes", "nolayer" , 
	...
	{ "bdo", TAG_BDO, 1, 0, 1, 0, 0, 0, { // 53 parents
						...
						"bdo"     , "big"     , "blink"   , "body"    , "button"  , 
						"caption" , "cite"    , "code"    , "dd"      , "del"     , 
						"dfn"     , "div"     , "dl"      , "dt"      , "em"      , 
						"fieldset", "h1"      , "h2"      , "h3"      , "h4"      , 
						"h5"      , "h6"      , "html"    , "i"       , "ins"     , 
						"kbd"     , "label"   , "layer"   , "legend"  , "li"      , 
						"marquee" , "multicol", "nobr"    , "nolayer" , "object"  , 
						"p"       , "pre"     , "q"       , "samp"    , "small"   , 
						"span"    , "strong"  , "sub"     , "sup"     , "td"      , 
						"th"      , "tt"      , "var"     , 
						NULL}
	},
	{ "label", TAG_LABEL, 1, 0, 1, 0, 0, 0, { // 56 parents
						...
						"h2"      , "h3"      , "h4"      , "h5"      , "h6"      , 
						"html"    , "i"       , "iframe"  , "ins"     , "kbd"     , 
						"legend"  , "li"      , "noframes", "noscript", "object"  , 
						"p"       , "pre"     , "q"       , "s"       , "samp"    , 
	...
	{ "h1", TAG_H1, 1, 0, 1, 0, 1, 1, { // 25 parents
						...
						"a"       , "blockquote", "body"    , "button"  , "center"  , 
	...
	{ "fieldset", TAG_FIELDSET, 1, 0, 1, 0, 1, 1, { // 22 parents
						...
						"blockquote", "body"    , "center"  , "dd"      , "del"     , 
						"div"     , "fieldset", "form"    , "html"    , "iframe"  , 
						"ins"     , "layer"   , "li"      , "map"     , "marquee" , 
						"multicol", "noframes", "nolayer" , "noscript", "object"  , 
						"td"      , "th"      , 
						NULL}
	...
	{ "h2", TAG_H2, 1, 0, 1, 0, 1, 1, { // 23 parents
						...
						"map"     , "marquee" , "multicol", "nolayer" , "noscript", 
						"object"  , "td"      , "th"      , 
						NULL}
	},
	...
	{ "br", TAG_BR, 0, 1, 0, 0, 0, 1, { // 63 parents
						...
						"kbd"     , "label"   , "layer"   , "legend"  , "li"      , 
						"marquee" , "multicol", "noframes", "nolayer" , "noscript", 
						"object"  , "p"       , "pre"     , "q"       , "s"       , 
						"samp"    , "small"   , "span"    , "strike"  , "strong"  , 
						"sub"     , "sup"     , "td"      , "th"      , "tr"      , 
						"tt"      , "u"       , "var"     , 
	...
	{ "param", TAG_PARAM, 0, 1, 0, 0, 1, 1, { // 4 parents
						...
						"applet"  , "body"    , "html"    , "object"  , 
						NULL}
	},
	{ "center", TAG_CENTER, 1, 0, 1, 0, 1, 1, { // 20 parents

						"blockquote", "body"    , "button"  , "center"  , "dd"      , 
						"del"     , "div"     , "fieldset", "font"    , "form"    , 
						"html"    , "iframe"  , "ins"     , "li"      , "map"     , 
	...
	{ "p", TAG_P, 1, 0, 0, 0, 1, 1, { // 24 parents
						...
						"address" , "blockquote", "body"    , "button"  , "center"  , 
	...
	{ "embed", TAG_EMBED, 0, 0, 1, 0, 1, 1, { // 12 parents
						...
						"blink"   , "body"    , "html"    , "layer"   , "marquee" , 
						"multicol", "nobr"    , "nolayer" , "object"  , "table"   , 
						"td"      , "tr"      , 
						NULL}
	},
	{ "marquee", TAG_MARQUEE, 0, 0, 1, 0, 1, 1, { // 25 parents

						"applet"  , "blockquote", "body"    , "center"  , "dd"      , 
						"div"     , "dl"      , "embed"   , "fieldset", "form"    , 
						"html"    , "iframe"  , "layer"   , "li"      , "multicol", 
	...
	{ "font", TAG_FONT, 0, 0, 1, 0, 0, 0, { // 63 parents
						...
						"h6"      , "html"    , "i"       , "iframe"  , "ins"     , 
						"kbd"     , "label"   , "layer"   , "legend"  , "li"      , 
						"marquee" , "multicol", "nobr"    , "noframes", "nolayer" , 
						"noscript", "object"  , "p"       , "q"       , "s"       , 
						"samp"    , "small"   , "span"    , "strike"  , "strong"  , 
						"sub"     , "sup"     , "td"      , "th"      , "title"   ,
						"tt"      , "u"       , "var"     , 
						NULL}
	...
	{ "dir", TAG_DIR, 0, 0, 1, 0, 1, 1, { // 21 parents
						...
						"blockquote", "body"    , "button"  , "center"  , "dd"      , 
						"div"     , "dl"      , "fieldset", "form"    , "html"    , 
						"iframe"  , "layer"   , "li"      , "marquee" , "multicol", 
						"noframes", "nolayer" , "noscript", "object"  , "td"      , 
						"th"      , 
						NULL}
	},
	...
	{ "sound", TAG_SOUND, 0, 1, 0, 0, 1, 1, { // 66 parents
						...
						"kbd"     , "label"   , "layer"   , "legend"  , "li"      , 
						"marquee" , "multicol", "nobr"    , "noembed" , "noframes", 
						"nolayer" , "noscript", "object"  , "p"       , "pre"     , 
						"q"       , "s"       , "samp"    , "small"   , "span"    , 
	...
	{ "comment", TAG_COMMENT, 0, 0, 1, 0, 0, 0, { // 103 parents
						...
						"bgsound" , "big"     , "blink"   , "blockquote", "body"    , 
						...
						"noframes", "nolayer" , "noscript", "object"  , "ol"      , 
						"optgroup", "option"  , "p"       , "param"   , "pre"     , 
						"q"       , "s"       , "samp"    , "script"  , "select"  , 
						"small"   , "sound"   , "spacer"  , "span"    , "strike"  ,
...
int html_tag_info_size = sizeof(html_tag_info_array)/sizeof(html_tag_info_t);
